...
export const MIDNIGHT_NETWORKS: Record<NetworkId, NetworkConfig> = {
  preprod: {
    ...
    explorerContractUrl: 'https://explorer.preprod.midnight.network/address/0x7a3f891b2c4e5d6f7a8b9c0d1e2f3a4b5c6d7e8f',
  ...
  preview: {
    ...
    explorerContractUrl: 'https://explorer.preview.midnight.network/address/0x3b8d91a1e2f4c5d6e7f8a9b0c1d2e3f4a5b6c7d8',
